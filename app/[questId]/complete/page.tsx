...
export default async function CompletePage() {
	...
	return (
		<div className="w-full min-h-svh grid place-items-center bg-neutral-50 py-6 px-6">
			<div className="max-w-6xl grid w-full px-10 xl:px-18 py-8 xl:py-16 rounded-3xl gap-10 xl:gap-16 bg-blue-50 shadow-lg shadow-black/5">
				<div className="flex flex-row gap-2 items-center justify-between">
					<Name />
					<Button asChild size={"lg"} className="text-sm xl:text-base">
						<Link href="/">
							<Home />
							ホームに戻る
						</Link>
				...
				<div className="grid gap-4">
					<h3 className="font-bold text-lg xl:text-2xl">次はどれをつくる？</h3>
